...
const HomeNavbarComponent: React.FC = () => {
  return (
    <div className="w-full flex flex-row h-[3rem] mt-2 justify-between px-8">
      ...
      <div className="flex flex-row gap-6 text-surface-neutral h-full items-center justify-end w-1/2 px-8">
