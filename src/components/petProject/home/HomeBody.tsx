...
const HomeBodyComponent: React.FC = () => {
  return (
    <div className="flex flex-row w-full h-full items-center justify-around px-10">
      <div className="w-full absolute">
        <Outlet />
      </div>
      <div className="relative w-2/4 h-full flex flex-col items-center justify-center gap-6 px-12">
